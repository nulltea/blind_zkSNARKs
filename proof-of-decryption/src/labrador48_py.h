...
double labrador48_composite_prove_simple(labrador48_composite *proof, labrador48_commitment *com, const labrador48_smplstmnt *st, const labrador48_witness *wt);
