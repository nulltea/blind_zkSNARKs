...
double labrador40_composite_prove_simple(labrador40_composite *proof, labrador40_commitment *com, const labrador40_smplstmnt *st, const labrador40_witness *wt);
