...
static void test_mul_extension(size_t deg) {
  ...
  if(!polzvec_iszero(a,deg))
    printf("ERROR in polxvec_mul_extension()\n");
  ...
  if(!polx_iszero(tmp0))
    printf("ERROR in polxvec_collaps_add_extension()\n");
}
...
int main(void) {
  ...
  polz_center(&c);
  if(!polz_iszero(&c))
      printf("ERROR in polz_bitpack/bitunpack\n");
  ...
  polz_center(&c);
  if(!polz_iszero(&c))
      printf("ERROR in polz_to/frompolx\n");
  ...
  polz_center(&c);
  if(!polz_iszero(&c))
      printf("ERROR in polz_decompose / polz_slli\n");
  ...
  polz_center(&c);
  if(!polz_iszero(&c))
      printf("ERROR in polz_decompose\n");
  ...
  polz_center(&c);
  if(!polz_iszero(&c))
      printf("ERROR in polz_reconstruct\n");
