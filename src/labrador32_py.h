...
double labrador32_composite_prove_simple(labrador32_composite *proof, labrador32_commitment *com, const labrador32_smplstmnt *st, const labrador32_witness *wt);
