...
double labrador24_composite_prove_simple(labrador24_composite *proof, labrador24_commitment *com, const labrador24_smplstmnt *st, const labrador24_witness *wt);
